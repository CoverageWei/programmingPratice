...
//        testListenableFuture();
    ...
    public static void testRateLimiter() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            System.out.println("acquire success..." + i + " , time = " + System.currentTimeMillis() / 1000);
            final ListenableFuture<Integer> listenableFuture = executorService.submit(new Task("" + i));
        }
...
class Task implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        System.out.println("return success.." + str + " , time = " + System.currentTimeMillis() / 1000);
